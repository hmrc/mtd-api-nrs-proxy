...
object AuthFixture {
  ...
  val vatAgentEnrolments: Enrolments =
    Enrolments(
      enrolments = Set(
        Enrolment(
          key = "HMRC-MTD-VAT",
  ...
  val saEnrolments: Enrolments =
    Enrolments(
      enrolments = Set(
        Enrolment(
          key = "HMRC-MTD-IT",
          identifiers = Seq(
            EnrolmentIdentifier("MTDITID", "123456789")
          ),
          state = "Active"
        )
      )
  ...
  val saAgentEnrolments: Enrolments =
    Enrolments(
      enrolments = Set(
        Enrolment(
          key = "HMRC-MTD-IT",
  ...
  val agentIdentityData: IdentityData = orgIdentityData.copy(
    ...
    UserDetails(
      ...
      identityData = Option(
        IdentityData(
          ...
          credentialRole = Some(User),
          mdtpInformation = None,
          itmpName = ItmpName(givenName = None, familyName = None, middleName = None),
          itmpDateOfBirth = None,
          itmpAddress = ItmpAddress(
            line1 = None,
            line2 = None,
